    ...
    <>
      ...
      >
        ...
        <div className="flex h-16 items-center gap-2.5 border-b border-gray-200 px-5">
          <svg className="h-7 w-7 text-indigo-600" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
          <span className="text-xl font-bold text-gray-900">
            Quest<span className="text-indigo-600">@</span>Stellar
          </span>
        </div>
              ...
              return (
                <li key={item.href}>
                  <Link
                    ...
                    onClick={onClose}
                    className={`
                      tap-target flex items-center gap-3 rounded-lg px-3 py-2.5
